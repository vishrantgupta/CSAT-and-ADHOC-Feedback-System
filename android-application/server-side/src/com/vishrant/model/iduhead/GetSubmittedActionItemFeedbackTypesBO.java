...
public class GetSubmittedActionItemFeedbackTypesBO {

	public String getSubmittedActionItemFeedbackTypes(String userName, String projectName) {
		...
		try (Connection connection = DBHelper.getConnection()){
			...
			"                              from PROJECTS " +
			"                             where UPPER(IDU_HEAD_ID) = UPPER('" + userName + "')" +
			"                           ) " +
